...
df_conf_mat_fallas.to_excel(f'Pruebas estabilidad/Original/sub_ventanas/matrices_conf_fallas/n{n}/m{m}/mat_conf_fallas_{distancia}km.xlsx')
df_accuracy_fallas.to_excel(f'Pruebas estabilidad/Original/sub_ventanas/matrices_conf_fallas/n{n}/m{m}/accuracy_{distancia}km_m{m}.xlsx')
fila_df_conf_mat_dists.to_excel(f'Pruebas estabilidad/Original/sub_ventanas/matrices_conf_dists/n{n}/m{m}/fila{distancia}km.xlsx')